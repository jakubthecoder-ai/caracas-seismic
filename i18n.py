...
TRANSLATIONS = {
    'es': {
        ...
        'notif_on': 'Notif ON',
        'notif_off': 'Notif OFF',
        'alert_critical': 'ALERTA SÍSMICA CRÍTICA — M{mag} — {place}',
        'alert_high': 'ALERTA SÍSMICA — M{mag} — {place}',
        'alert_medium': 'ACTIVIDAD SÍSMICA DETECTADA — M{mag}',
        'alert_waveform': 'ACTIVIDAD SÍSMICA DETECTADA EN {station}',
    ...
    'en': {
        ...
        'notif_on': 'Notif ON',
        'notif_off': 'Notif OFF',
        'alert_critical': 'CRITICAL ALERT — M{mag} — {place}',
        'alert_high': 'SEISMIC ALERT — M{mag} — {place}',
        'alert_medium': 'SEISMIC ACTIVITY DETECTED — M{mag}',
        'alert_waveform': 'SEISMIC ACTIVITY DETECTED AT {station}',
